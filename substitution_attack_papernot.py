...
# Cleverhans #
##############
from cleverhans.attack_tf import jacobian_graph, jacobian_augmentation



#def train_substitute_papernot(sess, x, y, bbox_preds, X_sub, Y_sub, nb_classes=10,
#        nb_epochs_s, batch_size, learning_rate, data_aug, lmbda):
#    model_sub = MNISTModel(use_log=True).model
#    preds_sub = model_sub(x)
#
#    grads = jacobian_graph(pres_sub, x, nb_classes)
#
#    for rho in xrange(data_aug):
#        print("sub train epoch #", str(rho))
#        train_params = {
#                'nb_epochs': nb_epochs_s,
#                'batch_size': batch_size,
#                'learning_rate': learning_rate}
#        model.fit(X_sub, bbox_preds, 
#                batch_size=batch_size, 
#                nb_epoch=nb_epochs_s,
#                shuffle=True)
#
#        if rho < data_aug-1 :
