...
class CarliniL2:
    def __init__(self, sess, model, batch_size=1, confidence = CONFIDENCE,
                 ...
                 use_log = False, adam_beta1 = 0.9, adam_beta2 = 0.999, defense = DEFENSE, noise= NOISE, k_samps=1, mix_defense=False):
        """
    ...
    def attack_batch(self, imgs, labs):
        ...
        # counter for # of queries per batch to model
        query_counter = 0
        ...
        for outer_step in range(self.BINARY_SEARCH_STEPS):
            ...
            for iteration in range(self.MAX_ITERATIONS):
                ...
                # Haidar: This is considered a query I think!
